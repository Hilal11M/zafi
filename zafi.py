...
"""%s
 ...
 - author          : Romi Afrizal
 - facebook    : https://www.facebook.com/m.hilal.7370
 - fanspage    : https://www.facebook.com/m.hilal.7370
 - whatsap     : +6285283864902
 - github         : https://github.com/Hilal11M
 - script name : ZAKI (Zona Akun Kontol Indonesia)
 - version     : 1.1
...
def menu():
    ...
    print (' [%s07%s] Cek opsi hasil crack'%(K,P)) 
    print (' [%s08%s] Cek hasil crack'%(K,P)) 
    #print (' [%s09%s] Gabung group'%(K,P))
    #print (' [%s10%s] Info script'%(K,P))
